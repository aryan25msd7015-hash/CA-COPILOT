...
import {
  BarChart3, BookOpen, Bot, BriefcaseBusiness, Building2, CalendarDays, ClipboardCheck,
  FileSearch, FileText, FolderOpen, Gauge, Gavel, Landmark, LayoutDashboard,
  LockKeyhole, MessageCircle, ReceiptIndianRupee, Scale, Search, ShieldCheck, ShieldAlert,
  Sparkles, Target, UploadCloud, UsersRound, BadgeCheck, ListChecks, LineChart, TriangleAlert,
} from 'lucide-react';
...
const ICONS: Record<string, ComponentType<{ className?: string }>> = {
  ...
  '/observations': ClipboardCheck,
  '/peer-review': ShieldCheck,
  '/portal': BriefcaseBusiness,
  '/query': Search,
  '/reconciliation': Gauge,
  '/reports': BarChart3,
  '/risk-scores': TriangleAlert,
  '/rfp': Target,
  '/roc-xbrl': FileText,
  '/secretarial': FileText,
  '/tds': ReceiptIndianRupee,
  '/team': UsersRound,
  '/timesheets': Sparkles,
  '/vault': LockKeyhole,
