        ...
        <section className="relative bg-[rgba(9,14,32,0.7)] p-6 sm:p-8">
          <div className="mx-auto max-w-md">
            ...
            <button
              ...
              className="group mt-5 flex w-full items-center justify-center gap-3 rounded-xl border border-line bg-[rgba(6,11,26,0.7)] px-4 py-3 text-sm font-medium text-fg-0 outline-none transition hover:-translate-y-0.5 hover:border-cyan-400/50 hover:bg-[rgba(15,22,45,0.85)] focus-visible:ring-2 focus-visible:ring-cyan-500/40"
            >
              ...
              <span className="chip chip-cyan">SSO</span>
              <ArrowRight className="h-4 w-4 text-fg-2 transition group-hover:translate-x-0.5 group-hover:text-cyan-300" />
            </button>

            <div className="mt-4 flex items-center gap-3">
              <span className="h-px flex-1 bg-line" />
              <span className="font-mono text-[10px] uppercase tracking-[0.22em] text-fg-3">Or with key</span>
              <span className="h-px flex-1 bg-line" />
            </div>
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-between rounded-xl border border-cyan-400/30 bg-cyan-500/[0.06] px-4 py-3 text-left text-sm font-medium text-cyan-100 outline-none transition hover:border-cyan-400/60 hover:bg-cyan-500/[0.1] focus-visible:ring-2 focus-visible:ring-cyan-500/40"
            >
